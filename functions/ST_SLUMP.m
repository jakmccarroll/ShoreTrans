...
% 31/12/2019, RJM
% Called by: ST_TRANSLATOR
% Applies an angle of repose to an eroding dune, to avoid a vertical sand cliff.
%
% INPUTS
    ...
    % Xi -> translation distance (e.g. Xi=-30 is onshore translation of 30m)
        % Xi is generated by a loop in ST_MAIN
% OUTPUTS
    ...
    for i=1:length(ind_cliff)
        ...
        %     duneOffPts=3
            ...
            try
                ...
                error(['Error in ST_SLUMP: Ran out of profile to slump dune back, ' 10 ...
